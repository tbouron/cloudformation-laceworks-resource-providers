...
1. Write the JSON schema describing your resource, [Lacework-alerts-rule.json](./Lacework-alerts-rule.json)
2. Implement your resource handlers in [handlers.ts](./Lacework-alerts-rule/handlers.ts)

> Don't modify [models.ts](./Lacework-alerts-rule/models.ts) by hand, any modifications will be overwritten when the `generate` or `package` commands are run.
