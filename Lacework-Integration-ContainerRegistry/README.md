...
1. Write the JSON schema describing your resource, [lacework-integration-containerregistry.json](./lacework-integration-containerregistry.json)
2. Implement your resource handlers in [handlers.ts](./lacework-integration-containerregistry/handlers.ts)

> Don't modify [models.ts](./lacework-integration-containerregistry/models.ts) by hand, any modifications will be overwritten when the `generate` or `package` commands are run.
