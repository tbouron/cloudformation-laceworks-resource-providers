...
1. Write the JSON schema describing your resource, [Lacework-alerts-profile.json](./Lacework-alerts-profile.json)
2. Implement your resource handlers in [handlers.ts](./Lacework-alerts-profile/handlers.ts)

> Don't modify [models.ts](./Lacework-alerts-profile/models.ts) by hand, any modifications will be overwritten when the `generate` or `package` commands are run.
