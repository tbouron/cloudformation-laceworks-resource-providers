import {AbstractLaceworkResource} from "./abstract-Lacework-resource";
...
class TestAbstractLaceworkResource extends AbstractLaceworkResource<BaseModel, {}, {}, {}, {}> {
...
describe('AbstractLaceworkResource', () => {
    describe('processRequestException', () => {
        let testInstance: TestAbstractLaceworkResource;

        beforeAll(() => {
            testInstance = new TestAbstractLaceworkResource('foo', BaseModel, undefined, undefined, BaseModel);
        });
        ...
        it.each([
            ...
            let axiosError: AxiosError<LaceworkError> = {
                config: undefined,
                isAxiosError: false,
                name: "",
                response: undefined,
