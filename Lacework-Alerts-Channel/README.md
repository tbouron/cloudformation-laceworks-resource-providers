...
1. Write the JSON schema describing your resource, [Lacework-alerts-channel.json](./Lacework-alerts-channel.json)
2. Implement your resource handlers in [handlers.ts](./Lacework-alerts-channel/handlers.ts)

> Don't modify [models.ts](./Lacework-alerts-channel/models.ts) by hand, any modifications will be overwritten when the `generate` or `package` commands are run.
