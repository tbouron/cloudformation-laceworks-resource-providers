...
1. Write the JSON schema describing your resource, [Lacework-queries-query.json](./Lacework-queries-query.json)
2. Implement your resource handlers in [handlers.ts](./Lacework-queries-query/handlers.ts)

> Don't modify [models.ts](./Lacework-queries-query/models.ts) by hand, any modifications will be overwritten when the `generate` or `package` commands are run.
