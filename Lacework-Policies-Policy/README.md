...
1. Write the JSON schema describing your resource, [lacework-policies-policy.json](./lacework-policies-policy.json)
2. Implement your resource handlers in [handlers.ts](./lacework-policies-policy/handlers.ts)

> Don't modify [models.ts](./lacework-policies-policy/models.ts) by hand, any modifications will be overwritten when the `generate` or `package` commands are run.
