...
1. Write the JSON schema describing your resource, [lacework-integration-cloudaccount.json](./lacework-integration-cloudaccount.json)
2. Implement your resource handlers in [handlers.ts](./lacework-integration-cloudaccount/handlers.ts)

> Don't modify [models.ts](./lacework-integration-cloudaccount/models.ts) by hand, any modifications will be overwritten when the `generate` or `package` commands are run.
